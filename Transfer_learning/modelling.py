...
def C3D_MIME20_training_model_tf(summary=True, backend='tf'):
    """ Return the Keras model of the network
    """
    from keras.models import Sequential
    from keras.layers.core import Dense, Dropout, Flatten
    ...
    model.add(Dense(4096, activation='relu', name='fc7'))
    model.add(Dropout(.5))
    model.add(Dense(20, activation='linear', name='fc8'))
...
def encoder_training_model_tf(summary=True, backend='tf'):
    """ Return the Keras model of the network
    """
    from keras.models import Sequential
    from keras.layers.core import Dense, Dropout, Flatten
